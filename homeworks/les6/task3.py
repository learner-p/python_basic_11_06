...
class Position(Worker):
    ...
    def get_total_income(self):
        print(f'зп составляет {sum([self._income["wage"],self._income["bonus"]])}')

a=Position("Ben","Big","Engineer",{"wage":20000,"bonus":4000})
print(a.name)
print(a.surname)
print(a.position)
print(a._income)
...
a.get_total_income()
print()
a=Position("Don","Bon","IT spec",{"wage":32000,"bonus":2000})
print(a.name)
print(a.surname)
print(a.position)
print(a._income)
